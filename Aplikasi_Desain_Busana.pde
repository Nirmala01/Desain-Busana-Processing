...
public void selectRok() {
  if (templateRok>0) {
    ...
    if (templateRok==1) { //POLA ROK PENDEK UKURAN S
      rok1.add(new Node(pg[3].width/2-40, 380));//0,100
      rok1.add(new Node(pg[3].width/2+40, 380));//100,0
      rok1.add(new Node(pg[3].width/2+40, 400));//100,100
      rok1.add(new Node(pg[3].width/2-40, 400));//0,0
...
void drawPgTutorial() {
  ...
  pg[11].text("   menampilkan rancangan dan pola busana yang pilih.", 10, 245);
  pg[11].text("3. Masukkan ukuran yang anda butuhkan dengan memilih", 10, 275);
  pg[11].text("   menu Ukuran dan klik. anda dapat memilih ukuran (S, M, L).", 10, 305);
  pg[11].text("4. Setelah membuat rancangan busana anda dapat", 10, 335);
  pg[11].text("   menambahkan tekstur dengan memilih menu Tekstur.", 10, 365);
  pg[11].text("   Pilihlah Tekstur yang anda inginkan.", 10, 395);
  ...
  pg[11].text("5. Anda dapat menyimpan rancangan pola busana", 10, 515);
  pg[11].text("   dengan memilih menu File kemudian Save.", 10, 545);
...
void drawPgTemplateAtasan() {
  ...
  pg[12].fill(0);
  pg[12].textSize(28);
  pg[12].text("Variasi Pola Baju perempuan", 25, 50);
  c = 1;
  for (int i=1; i<=9; i++) {
